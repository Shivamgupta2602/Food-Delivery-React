...
const About = () => {
  ...
  async function getProfile() {
    const data = await fetch("https://api.github.com/users/Shivamgupta2602");
      ...
      <Grid container direction="column" alignItems="center" spacing={3}>
        ...
        <Grid item>
          <Grid container direction="row" alignItems="center" spacing={1}>
            ...
            <Grid item>
              <StyledLink to="mailto:shivam2622000@gmail.com">
                <Typography variant="body2">
                  {"shivam2622000@gmail.com"}
                </Typography>
              </StyledLink>
            </Grid>
          </Grid>
        ...
        <Grid item>
          <Grid container direction="row" alignItems="center" spacing={1}>
            ...
            <Grid item>
              <StyledLink to="https://github.com/Shivamgupta2602">
                <Typography variant="body2">{"Shivamgupta2602"}</Typography>
              </StyledLink>
            </Grid>
          </Grid>
          <Grid
          ...
          >
            ...
            <Grid item>
              <StyledLink to="https://www.linkedin.com/in/shiv2/">
                <Typography variant="body2">{"shiv2"}</Typography>
              </StyledLink>
            </Grid>
          </Grid>
        </Grid>
